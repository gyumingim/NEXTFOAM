...
export function DateText({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[0.875rem] font-[600] text-gray-500 uppercase tracking-wide mb-2 ${className}`}>
      {children}
    </Text>
  )
}
...
export function MainTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[3rem] font-[900] text-black mb-4 leading-tight ${className}`}>
      {children}
    </Text>
  )
}
...
export function SectionTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[2.5rem] font-[700] text-black mb-[4rem] ${className}`}>
      {children}
    </Text>
  )
}
...
export function NewsTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[3rem] font-[700] text-black ${className}`}>
      {children}
    </Text>
  )
}
...
export function SubTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[1.5rem] font-[700] text-black mb-4 ${className}`}>
      {children}
    </Text>
  )
}
...
export function BodyText({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[1rem] font-normal text-black mb-6 leading-relaxed w-[90%] ${className}`}>
      {children}
    </Text>
  )
}
...
export function WhiteTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[3rem] font-black text-white ${className}`}>
      {children}
    </Text>
  )
}
...
export function LargeWhiteTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-white text-[5rem] font-[700] mb-[3.5rem] mt-[10rem] drop-shadow-lg leading-[5rem] ml-[4.5rem] ${className}`}>
      {children}
    </Text>
  )
}
...
export function PartnerTitle({ children, className = "" }: TextProps) {
  return (
    <Text className={`text-[2.5rem] font-[700] text-black mb-[3rem] mt-[4rem] ${className}`}>
      {children}
    </Text>
  )
}
